...
export default function MyDevPortfolio() {
  ...
  return (
    <>
      <SEO
        title={intl.formatMessage({id:"SEO_Title", defaultMessage:"Software Developer Portfolio of Janos Meszaros - Projects and Expertise"})}
        description={intl.formatMessage({id:"SEO_Desc", defaultMessage:"Professional Software Developer Portfolio showcasing my projects, technical skills, and expertise in web development, programming, and software engineering."})}
        type={intl.formatMessage({id:"SEO_Type", defaultMessage:"website"})}
        keywords={intl.formatMessage({id:"SEO_Keywords", defaultMessage:"Full-Stack Developer, Web Developer Portfolio, Software Engineer, Janos Meszaros, Programming Projects, Technical Skills, Web Development, Software Engineering, Frontend Development, Backend Development"})}
        metaTitle="myDevPortfolio"
      />
      
      <div id='void' className='bg-gradient-to-tl from-uni-bg to-uni-palette/90'> 
        {/* <div id='frame' className='fixed h-full w-full border-gray-200 border-solid qborder-[15px] border-t-0 md:border-t-[15px] z-0'/> */}
