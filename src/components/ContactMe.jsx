            ...
            <div className="py-8 mx-auto w-[70%]">
                ...
                <form ref={form} onSubmit={sendEmail} id="contactMe" className="space-y-3 text-black">
                    <div>
                        ...
                        <input type="email" name="user_email" className="shadow-sm bg-gray-200 border border-gray-300 text-sm text-left rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 " placeholder="janos@meszaros.com" required>
                        </input>
                    </div>
                    <div>
                        ...
                        <input type="text" name="subject" className="block p-3 w-full text-sm text-left bg-gray-2000 rounded-lg border bg-gray-200  border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 " placeholder="Interested in..." required>
                        </input>
                    </div>
                    <div className="sm:col-span-2">
                        ...
                        <textarea name="message" rows="6" className="block p-2.5 w-full text-sm bg-gray-200  rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 " placeholder="Let me know your thoughts...">
                        </textarea>
                    </div>
