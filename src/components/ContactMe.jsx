        ...
        <section id='contact' className="text-uni-text pt-3">
            <div className="py-10 mx-auto w-[70%]">
                ...
                <p className="pb-8 lg:pb-16 font-light text-center text-uni-text text-xl">
                    <FormattedMessage
                        id = "contactMeIntro"
                        defaultMessage="Are you interested in what you see? Let me know."
                    />
                </p>
                <form ref={form} onSubmit={sendEmail} id="contactMe" className="space-y-3 text-black">
                    ...
                    <div>
                        ...
                        <input type="text" id="subject" name="subject" className="block p-3 w-full text-sm text-left bg-gray-2000 rounded-lg border bg-gray-200  border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 " placeholder={context.locale.includes('hu') ? "Tárgy" : "About"} required>
                        </input>
                    </div>
                    <div className="sm:col-span-2">
                        ...
                        <textarea name="message" id="message" rows="6" className="block p-2.5 w-full text-sm bg-gray-200  rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 " placeholder={context.locale.includes('hu') ? "Érdeklődöm, hogy ..." : "Let me know your thoughts ..."}>
                        </textarea>
                    </div>
                ...
                > 
                    ...
                    <div className="flex justify-center flex-col">
                        ...
                        <p className='text-center text-md'>
                            <FormattedMessage
                                id = "contactMeSent"
                                defaultMessage="Thank you for your email! I have received your message and will be in touch soon."
                            />
                        </p>                         
                    </div>
