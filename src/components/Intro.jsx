...
function Intro({ openModal }){
    ...
    return(
        <section id='section-intro' className='rounded-xl bg-uni-fill sm:h-[90vh] md:h-[60vh] md:min-h-[400px] xl:min-w-[400px] xl:w-[20vh] xl:max-w-[500px] xl:min-h-[400px] xl:h-[80vh] xl:max-h-[600px] xl:float-left '>
